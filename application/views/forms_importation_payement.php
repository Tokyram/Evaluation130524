    ...
    <div class="row mt-3">
      ...
      <div class="col-lg-6">
        <div class="card">
           ...
           <hr>
           <form action="<?= base_url("Controller/upload_csv_paiement"); ?>" method="post" enctype="multipart/form-data">
              <div class="form-group">
                  <label for="csv_file_paiement">Ajouter votre fichier CSV de paiement</label>
                  <input type="file" name="csv_file_paiement" class="form-control form-control-rounded" id="csv_file_paiement" placeholder="Importer le fichier">
              </div>
              <div class="form-group">
